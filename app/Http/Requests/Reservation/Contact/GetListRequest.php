...
namespace App\Http\Requests\Reservation\Contact;
...
/**
 * ご連絡一覧のリクエストパラメータを制御します。
 * Class GetListRequest
 * @package App\Http\Requests\Reservation\Contact
 */
class GetListRequest extends BaseRequest
{
    ...
    protected function getValidatorInstance()
    {
        ...
        if (!$data || !array_key_exists('search_con', $data) || count($data["search_con"]) <= 3) {
