...
/**
 * 旅行社販売店登録ソケットのメッセージクラスです。
 * Class AgentInsertOperation
 * @package App\Operations
 */
class AgentInsertOperation extends BaseOperation
{
    /**
     * 初期化します。
     */
    ...
    {
        $this->setCommonOperationCode('241');
    }
     ...
     * @throws \Exception
     */
    public function agentCode($agent_code)
    {
        $this->set(7, 43, $agent_code);
    }
    ...
    public function agentName($agent_name)
    {
        $this->set(72, 50, $agent_name);
    }
     ...
     * @throws \Exception
     */
    public function agent_type($agent_type)
    {
